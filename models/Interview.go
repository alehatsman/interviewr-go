...
type InterviewViewModel struct {
	...
	Vacancy   Vacancy       `json:"vacancy" bson:"vacancy" binding:"required"`
	Candidate User          `json:"candidate" bson:"candidate" binding:"required"`
	Company   Company       `json:"company" bson:"company" binding:"required"`
}
